// --------------------------------------------------------------
// Servidor: Mantenimiento de Notas del Presupuesto
// --------------------------------------------------------------
...
/* GET home page. */
router.get('/manten_notas_ppto', async function (req, res, next) {
    ...
    var content;
    fs.readFile('./views/manten_notas_ppto.pug', function read(err, data) {
        if (err) {
            throw err;
        }
        content = data;
