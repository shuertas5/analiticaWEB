// --------------------------------------------------------------
// Servidor: Mantenimiento de Lineas Analiticas
// --------------------------------------------------------------
...
/* GET home page. */
router.get('/manten_lineas', async function (req, res, next) {
    ...
    var content;
    fs.readFile('./views/manten_lineas.pug', function read(err, data) {
        if (err) {
            throw err;
        }
        content = data;
