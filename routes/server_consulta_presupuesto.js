...
/* GET home page. */
router.get('/consulta_presupuesto', async function (req, res, next) {
    ...
    var content;
    fs.readFile('./views/consulta_presupuesto.pug', function read(err, data) {
        if (err) {
            throw err;
        }
        content = data;
...
router.post('/consulta_presupuesto', async function (req, res, next) {
