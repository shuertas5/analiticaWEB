...
const regular_font = require('./CourierPrime-Regular-normal.js');
const bold_font = require('./CourierPrime-Bold-bold.js');
const italic_font = require('./CourierPrime-Italic-italic.js');
const bold_italic = require('./CourierPrime-BoldItalic-bolditalic.js');
...
class Treu_print_jspdf {
    ...
    ponerValores() {
        ...
        this.imp_pdf.setFont("CourierPrime-Regular", 'normal');
    ...
    setNegrita(boo) {
        ...
        if (boo == true) {
            this.ennegrita = true;
            opc = "bold";
            this.imp_pdf.setFont("CourierPrime-Bold", 'bold');
        }
        if (boo == false) {
    ...
    setCursiva(boo) {
        ...
        if (boo == true) {
            this.encursiva = true;
            opc = "italic";
            this.imp_pdf.setFont("CourierPrime-Italic", 'italic');
        }
        if (boo == false) {
    ...
    print(serie) {
        ...
        if (this.afichero == false && this.aprevisualizacion == false && this.aficheropdf == false && this.aprevisualizacionpdf == false) {
            ...
            this.imp_pdf.text(serie, this.posix, this.posiy);
...
module.exports = {
    Treu_print_jspdf: Treu_print_jspdf
}