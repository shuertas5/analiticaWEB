...
class TablaAdicionalesCorrecciones extends tablaSQL.TablaSQL {
    ...
    constructor(co) {
        super(co, "ADICIONALES_CORRECCIONES");
        this.isJDBCon = true;
	...
	setPrimaryIndex() {
		this.pstmtin.push("SELECT * FROM ADICIONALES_CORRECCIONES WHERE INDICE = $1 ");
		this.pstmtin.push("DELETE FROM ADICIONALES_CORRECCIONES WHERE INDICE = $1 ");
	}
...
module.exports = {
    TablaAdicionalesCorrecciones: TablaAdicionalesCorrecciones
}
