...
class TablaAdicCostesCopia extends tablaSQL.TablaSQL {
	...
	setPrimaryIndex() {
		this.pstmtin.push("SELECT * FROM ADIC_COSTES_COPIA WHERE INDICE = $1 ");
		this.pstmtin.push("DELETE FROM ADIC_COSTES_COPIA WHERE INDICE = $1 ");
	}
...
module.exports = {
    TablaAdicCostesCopia: TablaAdicCostesCopia
}
