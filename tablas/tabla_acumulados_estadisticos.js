...
class TablaAcumuladosEstadisticos extends tablaSQL.TablaSQL {
    ...
    constructor(co) {
        super(co, "ACUMULADOS_ESTADISTICOS");
        this.isJDBCon = true;
	...
	setPrimaryIndex() {
		this.pstmtin.push("SELECT * FROM ACUMULADOS_ESTADISTICOS WHERE INDICE = $1 ");
		this.pstmtin.push("DELETE FROM ACUMULADOS_ESTADISTICOS WHERE INDICE = $1 ");
	}
...
module.exports = {
    TablaAcumuladosEstadisticos: TablaAcumuladosEstadisticos
}
