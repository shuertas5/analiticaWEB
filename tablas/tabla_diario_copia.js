...
class TablaDiarioCopia extends tablaSQL.TablaSQL {
    ...
    setPrimaryIndex() {
        this.pstmtin.push("SELECT * FROM DIARIO_COPIA WHERE ORIGEN = $1 AND SECUENCIA = $2");
        this.pstmtin.push("DELETE FROM DIARIO_COPIA WHERE ORIGEN = $1 AND SECUENCIA = $2");
        this.pstmtin.push("DELETE FROM DIARIO_COPIA WHERE ORIGEN = $1");
    }
...
module.exports = {
    TablaDiarioCopia: TablaDiarioCopia
}
