...
class TablaRepartoPptoLineas extends tablaSQL.TablaSQL {
    ...
    setPrimaryIndex() {
        this.pstmtin.push("SELECT * FROM REPARTO_PPTO_LINEAS WHERE HOJA = $1 AND LINEA = $2");
        this.pstmtin.push("DELETE FROM REPARTO_PPTO_LINEAS WHERE HOJA = $1  AND LINEA = $2");
    }
...
module.exports = {
    TablaRepartoPptoLineas: TablaRepartoPptoLineas
}