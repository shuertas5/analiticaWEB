...
class TablaCifrasExtras extends tablaSQL.TablaSQL {
    ...
    setPrimaryIndex() {
        this.pstmtin.push("SELECT * FROM CIFRAS_EXT WHERE HOJA = $1 AND LINEA = $2");
        this.pstmtin.push("DELETE FROM CIFRAS_EXT WHERE HOJA = $1  AND LINEA = $2");
    }
...
module.exports = {
    TablaCifrasExtras: TablaCifrasExtras
}