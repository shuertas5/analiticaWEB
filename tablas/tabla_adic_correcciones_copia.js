...
class TablaAdicCorreccionesCopia extends tablaSQL.TablaSQL {
    ...
    constructor(co) {
        super(co, "ADIC_CORRECCIONES_COPIA");
        this.isJDBCon = true;
	...
	setPrimaryIndex() {
		this.pstmtin.push("SELECT * FROM ADIC_CORRECCIONES_COPIA WHERE INDICE = $1 ");
		this.pstmtin.push("DELETE FROM ADIC_CORRECCIONES_COPIA WHERE INDICE = $1 ");
	}
...
module.exports = {
    TablaAdicCorreccionesCopia: TablaAdicCorreccionesCopia
}
