...
class TablaHistoricoCifrasExtras extends tablaSQL.TablaSQL {
	...
	setPrimaryIndex() {
		this.pstmtin.push("SELECT * FROM HISTO_CIFRAS_EXTRAS WHERE ANNO= $1 AND HOJA = $2 AND LINEA = $3");
		this.pstmtin.push("DELETE FROM HISTO_CIFRAS_EXTRAS WHERE ANNO= $1 AND HOJA = $2  AND LINEA = $3");
		this.pstmtin.push("DELETE FROM HISTO_CIFRAS_EXTRAS WHERE ANNO= $1");
	}
...
module.exports = {
    TablaHistoricoCifrasExtras: TablaHistoricoCifrasExtras
}