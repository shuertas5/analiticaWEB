...
class TablaAcumEstadisticosCopia extends tablaSQL.TablaSQL {
    ...
    constructor(co) {
        super(co, "ACUM_ESTADISTICOS_COPIA");
        this.isJDBCon = true;
	...
	setPrimaryIndex() {
		this.pstmtin.push("SELECT * FROM ACUM_ESTADISTICOS_COPIA WHERE INDICE = $1 ");
		this.pstmtin.push("DELETE FROM ACUM_ESTADISTICOS_COPIA WHERE INDICE = $1 ");
	}
...
module.exports = {
    TablaAcumEstadisticosCopia: TablaAcumEstadisticosCopia
}
