...
class TablaAdicEstadisticosCopia extends tablaSQL.TablaSQL {
    ...
    constructor(co) {
        super(co, "ADIC_ESTADISTICOS_COPIA");
        this.isJDBCon = true;
	...
	setPrimaryIndex() {
		this.pstmtin.push("SELECT * FROM ADIC_ESTADISTICOS_COPIA WHERE INDICE = $1 ");
		this.pstmtin.push("DELETE FROM ADIC_ESTADISTICOS_COPIA WHERE INDICE = $1 ");
	}
...
module.exports = {
    TablaAdicEstadisticosCopia: TablaAdicEstadisticosCopia
}
