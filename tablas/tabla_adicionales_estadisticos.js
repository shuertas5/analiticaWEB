...
class TablaAdicionalesEstadisticos extends tablaSQL.TablaSQL {
    ...
    constructor(co) {
        super(co, "ADICIONALES_ESTADISTICOS");
        this.isJDBCon = true;
	...
	setPrimaryIndex() {
		this.pstmtin.push("SELECT * FROM ADICIONALES_ESTADISTICOS WHERE INDICE = $1 ");
		this.pstmtin.push("DELETE FROM ADICIONALES_ESTADISTICOS WHERE INDICE = $1 ");
	}
...
module.exports = {
    TablaAdicionalesEstadisticos: TablaAdicionalesEstadisticos
}
