...
class TablaCorreccionesEspecialesCopia extends tablaSQL.TablaSQL {
    ...
    constructor(co) {
        super(co, "CORRECCIONES_ESPE_COPIA");
        this.isJDBCon = true;
	...
	setPrimaryIndex() {
		this.pstmtin.push("SELECT * FROM CORRECCIONES_ESPE_COPIA WHERE INDICE = $1 ");
		this.pstmtin.push("DELETE FROM CORRECCIONES_ESPE_COPIA WHERE INDICE = $1 ");
	}
...
module.exports = {
    TablaCorreccionesEspecialesCopia: TablaCorreccionesEspecialesCopia
}
